window.addEventListener("load", () => {
  ...
  const openSearch = () => {
    ...
    btfanimateIn($searchMask, "to_show 0.5s");
    btfanimateIn(document.querySelector("#local-search .search-dialog"), "titleScale 0.5s");
    setTimeout(() => {
  ...
  const closeSearch = () => {
    ...
    bodyStyle.width = "";
    bodyStyle.overflow = "";
    btfanimateOut(document.querySelector("#local-search .search-dialog"), "search_close .5s");
    btfanimateOut($searchMask, "to_hide 0.5s");
  };
  ...
  window.addEventListener("pjax:complete", () => {
    !btfisHidden($searchMask) && closeSearch();
    searchClickFn();
  });
});
